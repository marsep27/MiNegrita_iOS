...
@Component({
  selector: 'app-gloriosos',
  templateUrl: './gloriosos.page.html',
  styleUrls: ['./gloriosos.page.scss'],
})
export class GloriososPage implements OnInit {
  ...
  audio() {
    ...
    //Current song audio
    this.currSong = new Audio("/assets/audio/Misterios Gloriosos del Santo Rosario.mp3");
