...
@Component({
  selector: 'app-dolorosos',
  templateUrl: './dolorosos.page.html',
  styleUrls: ['./dolorosos.page.scss'],
})
export class DolorososPage implements OnInit {
  ...
  audio() {
    ...
    //Current song audio
    this.currSong = new Audio("/assets/audio/Misterios Dolorosos del Santo Rosario.mp3");
