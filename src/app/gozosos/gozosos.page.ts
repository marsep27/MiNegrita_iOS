...
@Component({
  selector: 'app-gozosos',
  templateUrl: './gozosos.page.html',
  styleUrls: ['./gozosos.page.scss'],
})
export class GozososPage implements OnInit {
  ...
  audio() {
    ...
    //Current song audio
    this.currSong = new Audio("/assets/audio/Misterios Gozosos del Santo Rosario.mp3");
